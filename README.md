...
| [`devops-multi-stage-deployment`](./devops-multi-stage-deployment) | Azure DevOps multi-stage pipeline deploying a FastAPI app with testing, Key Vault, Bicep, and approvals |
